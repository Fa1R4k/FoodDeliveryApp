...
class Server @Inject constructor() {
        ...
        return listOf(
            listOf(
                ProductItemResponse(1,
                    ...
                    "Пицца",
                    mapOf("Маленькая" to 13.9, "Средняя" to 22.9, "Большая" to 27.9)),
                ProductItemResponse(2,
                    ...
                    "Пицца",
                    mapOf("Маленькая" to 17.9, "Средняя" to 25.9, "Большая" to 29.9)),
                ...
                ProductItemResponse(5,
                    ...
                    "Пицца",
                    mapOf("Маленькая" to 11.9, "Средняя" to 19.9, "Большая" to 25.9)),
                ProductItemResponse(6,
                    "Пепперони фреш",
                ...
                ProductItemResponse(7,
                    ...
                    "Пицца",
                    mapOf("Маленькая" to 20.9, "Средняя" to 28.4, "Большая" to 32.4)),
                ...
                ProductItemResponse(11,
                    ...
                    "Пицца",
                    mapOf("Маленькая" to 19.9, "Средняя" to 26.4, "Большая" to 30.4))),
            listOf(ProductItemResponse(12,
                "Гамбургер",
            ...
            listOf(ProductItemResponse(21,
                ...
                ProductItemResponse(26,
                    ...
                    "Роллы",
                    mapOf("4 шт." to 8.9, "8 шт." to 15.9, "12 шт." to 20.0)),
                ProductItemResponse(27,
                    "Техасская резня",
                    ...
                    "Роллы",
                    mapOf("4 шт." to 8.9, "8 шт." to 16.0, "12 шт." to 21.0)),
                ProductItemResponse(28,
                    "Теплый",
                ...
                ProductItemResponse(29,
                    ...
                    "Роллы",
                    mapOf("4 шт." to 8.9, "8 шт." to 16.0, "12 шт." to 23.9))),
            listOf(
                ProductItemResponse(30,
                    "Картофель Фри",
            ...
            listOf(
                ProductItemResponse(36,
                    ...
                    "Напитки",
                    mapOf("0,3 л." to 3.0, "0,5 л." to 3.9, "0,8 л." to 4.9)),
                ProductItemResponse(37,
                    "Кока-Кола Зеро",
    ...
    fun getPrice(id: Int, parameter: String): Double {
        ...
        return productItem.price!![parameter]!!
    }

    fun getUserById(id: String): UserItemResponse {
        return userList.first { it.id == id }
    }

    fun createUser(user: UserItemResponse) {
        userList.add(user)
    }

    fun login(number: String, hashPassword: String): String {
        if (userList.any { it.number == number } &&
            userList.any { it.hashPassword == hashPassword }
        ) {
            return userList.first { it.number == number }.id.toString()
        }
        return "error"
    }

    fun getList(): List<UserItemResponse> = userList

    companion object {
        private var userList: MutableList<UserItemResponse> =
            mutableListOf()
    }
}